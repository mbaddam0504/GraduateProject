         ...
         <table>
             <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="mediaName" name="fileName" required maxlength="50">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <textarea rows="05" cols="23" id="mediaDesc" name="fileDescription" required maxlength="1000"></textarea>
                        </td>
                    </tr>
                     <tr>
                        <td><br></td>
