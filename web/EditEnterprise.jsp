                                            ...
                                            <form method="post" action="EditEnterpriseServlet" enctype="multipart/form-data">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="enterpriseName" required value="${selectedEnterpriseDetails.enterpriseName}" maxlength="50">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <textarea rows="05" cols="23" name="enterpriseDescription" required maxlength="2000">${selectedEnterpriseDetails.enterpriseDescription}</textarea>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br>
