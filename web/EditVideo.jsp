                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="choose_file">
                                ...
                                <input type="file" id="uploadImage" accept="video/*" name="fileAddress" onchange="previewImage()" required/>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="mediaName" name="videoName" value="${selectedVideo.videoName}" required maxlength="50">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea rows="05" cols="23" id="mediaDesc" name="videoDescription" maxlength="1000">${selectedVideo.videoDesc}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td><br></td>
