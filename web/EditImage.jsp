         ...
         <table>
            <!-- <tr><img src="${selectedImage.imagePath}" alt="not available"></tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="mediaName" name="imageName" value="${selectedImage.imageName}" required maxlength="50">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <textarea rows="05" cols="23" id="mediaDesc" name="imageDescription" required maxlength="1000">${selectedImage.imageDesc}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td><br></td>
